...
const ExploreCryptoSection = () => {
	return (
		<section className="flex flex-col items-center bg-gray-10 w-full">
			{/* Container — max-w-[1500px] on md, max-w-[1920px] on lg */}
			<div className="relative flex flex-col w-full max-w-[1920px] px-6 py-12 md:px-8 md:py-16 md:max-w-[1500px] lg:px-12 lg:py-20 lg:max-w-[1920px]">
