				...
				<div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
					...
					<div className="w-full md:w-1/2">
						...
						<p className="text-body text-gray-40 mb-8 max-w-lg">
							Powerful analytical tools with the safety and security of CryptoApp deliver the ultimate trading experience. Tap into sophisticated charting capabilities, real-time order books, and deep liquidity across hundreds of markets.
						</p>
